...
import banger.domain.html5.DataAuthResultDO;
...
import banger.util.Md5Util;
import banger.util.HttpUtil;
...
public class SendSmsUtil {
    ...
    public static String addApp(String appName){
        ...
        String token= Md5Util.getMD5(appName+dateTime+SmsConfig.getUserName()+Md5Util.getMD5(SmsConfig.getPassword()));
    ...
    public static String addSignature(String appId, String smsSign,String notifyUrl) {
        ...
        long dateTime=new Date().getTime()/1000;
        String token= Md5Util.getMD5(appId+dateTime+smsSign+SmsConfig.getUserName()+Md5Util.getMD5(SmsConfig.getPassword()));
        map.put("DateTime",dateTime+"");
    ...
    public static String addTemplate(String appId, String smsType, String smsContent,String notifyUrl) {
        ...
        long dateTime=new Date().getTime()/1000;
        String token=Md5Util.getMD5(appId+dateTime+smsContent+smsType+SmsConfig.getUserName()+Md5Util.getMD5(SmsConfig.getPassword()));
        map.put("DateTime",dateTime+"");
        map.put("Notify_Url",notifyUrl);
        map.put("Token",token);
        String json = JSONObject.toJSONString(map);
    ...
    public static boolean delTemplate(String appId,String smsContent){
        ...
        map.put("SMSContent",smsContent);
        long dateTime=new Date().getTime()/1000;
        String token= Md5Util.getMD5(appId+dateTime+smsContent+SmsConfig.getUserName()+Md5Util.getMD5(SmsConfig.getPassword()));
        map.put("DateTime",dateTime+"");
        map.put("Token",token);
        String json = JSONObject.toJSONString(map);
