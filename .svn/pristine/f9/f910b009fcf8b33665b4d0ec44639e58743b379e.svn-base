...
public class JsonType {
	...
	public static JsonValueType getJsonType(Object obj) {
        ...
        else if (obj instanceof String)
        {
            ...
            {
                if (str.charAt(0) == '[' && str.charAt(str.length() - 1) == ']') return JsonValueType.Array;
                else if (str.charAt(0) == '{' && str.charAt(str.length() - 1) == '}') return JsonValueType.Object;
            }
        ...
        else return JsonValueType.Undefine;
	}
}
