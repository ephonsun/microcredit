...
public class LabelBlock {
    ...
    {
    	if (this.getCurrent() == null && !Character.isWhitespace(c)){
        ...
        if (this.getCurrent() != null){
            if (!Character.isWhitespace(c)){
                ...
                if (this.getCurrent().getCloseQuote().equals("")){
    ...
    private JsonLabelType getJsonValueType(char c)
    {
        ...
        if (jlt != JsonLabelType.Value) return jlt;
        else
        {
            switch (c)
            {
                ...
                default:
                    {
                        ...
                        else return JsonLabelType.Boolean;
                    }
            }
        }
    }
