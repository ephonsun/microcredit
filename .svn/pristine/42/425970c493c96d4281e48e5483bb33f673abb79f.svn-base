...
function setFileUpload(script,sizeLimit,queueSizeLimit,uploadFileType,fileInput,fileQueue,bizType,buttonText) {
	...
	$("#"+fileInput).uploadify({
		...
		'buttonText' : buttonText,//浏览按钮上的文字  
		...
		'onComplete' : function(event, queueID, fileObj, response, data) {
			...
			fileDiv.setAttribute("class", fileQueue);
			fm.appendChild(fileDiv);
			
			//文件ID
			var fileInputId = document.createElement("input");
			fileInputId.setAttribute("name", "fileId"+bizType);
			...
			fileInputSize.setAttribute("name", "fileSize"+bizType);
			...
			fileInputOldName.setAttribute("name", "fileNameOld"+bizType);
