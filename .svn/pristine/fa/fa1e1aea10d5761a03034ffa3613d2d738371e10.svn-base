 ...
 * 贷款资料附件文件表
 */
public class LoanInfoAddedFiles implements Serializable {
	private static final long serialVersionUID = 8349244899313381613L;
	private Integer id;					//主键ID
	private Integer ownerId;					//附件对像ID
	private Integer classId;					//附件分类ID
