 ...
 * 进件管理模板字段表
 */
public class IntoTemplatesField implements Serializable {
	private static final long serialVersionUID = 5906994088175160498L;
	...
	private Integer isMust;					//是否必填 1是，0否
