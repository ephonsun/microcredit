package banger.framework.writer;
...
public class Writer {
    ...
    public static IPropertyWriter<String> stringWriter()
    {
        ...
        {
            stringWriter = new Writer.StringWriter(objectWriter());
        }
        return stringWriter;
    }
    ...
    public static IPropertyWriter<Integer> intWriter()
    {
        if(intWriter==null)
        {
            intWriter = new Writer.IntegerWriter(objectWriter());
        }
        return intWriter;
    }
    ...
    public static IPropertyWriter<Boolean> boolWriter()
    {
        if(boolWriter==null)
        {
            boolWriter = new Writer.BooleanWriter(objectWriter());
        }
        return boolWriter;
    }
