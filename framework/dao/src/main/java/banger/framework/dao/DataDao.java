...
import banger.framework.dao.EntityDao.PageSizeHelper;
...
import banger.framework.sql.builder.SqlStringBuilder;
...
public class DataDao implements IDataDao {
	...
	public int execute(String sqlId,Object ... conditions){
		ISqlEngine ish = ("".equals(dbConfig))?SqlEngine.instance():SqlEngine.instance(dbConfig);
		int result = ish.executeNoneQuery(sqlId,conditions);
		ish.dispose();
		return result;
	}
	...
	public int[] executes(String sqlId,List<?> conditions){
		ISqlEngine ish = ("".equals(dbConfig))?SqlEngine.instance():SqlEngine.instance(dbConfig);
		int[] result = ish.executeNoneQuerys(sqlId,conditions);
		ish.dispose();
		return result;
	}
	...
	private SqlString buildInsertSqlString(String tableName,String pkName,Object pkValue,String[] columnNames,Object[] columnValues){
	...
	private SqlString buildUpdateSqlString(String tableName,String pkName,Object pkValue,String[] columnNames,Object[] columnValues){
		SqlStringBuilder sqlBuilder = new SqlStringBuilder();
