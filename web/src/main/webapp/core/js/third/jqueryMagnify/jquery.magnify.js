...
Magnify.prototype = {
    ...
    creatDOM: function () {
        ...
        var btnsTpl = {
            ...
            mydelete: '<button class="magnify-button magnify-button-close" title="rotate-delete">\
                            <i class="' + this.options.icons.mydelete + '" aria-hidden="true"></i>\
                        </button>'
        }
