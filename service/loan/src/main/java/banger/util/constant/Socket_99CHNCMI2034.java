...
/**
 *9.1.2.4. 签订、注销合同同步接口 格式不同 特殊处理
 */
public class Socket_99CHNCMI2034 extends BaseXmlBeanEnum {

    public Socket_99CHNCMI2034(String elementName, String elementColumnName, String elementLength, String elementNotNull, Map<String, String> elementOptions, String elementDefaultValue) {
    ...
    public static List<BaseXmlBeanEnum> getAllElement() {
        ...
        try {
            list = BaseXmlBeanEnum.getEnumList(Socket_99CHNCMI2034.class);
        }catch (Exception e){
        }
        return list;
    }
    ...
    public static String getSocketCode() {
        return Socket_99CHNCMI2034.class.getName().split("_")[1];
    }
