 ...
 * 营销客户表数据访问接口
 */
public interface ICustMarketCustomerDao {

	/**
	 * 新增营销客户表
	 * @param custMarketCustomer 实体对像
	 */
	void insertCustMarketCustomer(CustMarketCustomer custMarketCustomer);

	/**
	 *修改营销客户表
	 * @param custMarketCustomer 实体对像
	 */
	void updateCustMarketCustomer(CustMarketCustomer custMarketCustomer);
